...
window.$dvbs||parent.$dvbs,window.$dv.dvObjType="dvbs"}catch(e){}}.toString()+')();\x3c/script></head><body><script type="text/javascript">('+(c||"function() {}")+')("'+b.cdnAddress+'");\x3c/script><script type="text/javascript">setTimeout(function() {document.close();}, 0);\x3c/script></body></html>'}function I(c){var b=0,e;for(e in c)c.hasOwnProperty(e)&&++b;return b}function O(c,b){a:{var e={};try{if(c&&c.performance&&c.performance.getEntries){var f=c.performance.getEntries();for(c=0;c<f.length;c++){var d=
f[c],h=d.name.match(/.*\/(.+?)\./);if(h&&h[1]){var k=h[1].replace(/\d+$/,""),l=b[k];if(l){for(var m=0;m<l.stats.length;m++){var t=l.stats[m];e[l.prefix+t.prefix]=Math.round(d[t.name])}delete b[k];if(!I(b))break}}}}var g=e;break a}catch(w){}g=void 0}if(g&&I(g))return g}function P(c,b){var e,f=window._dv_win.document.visibilityState;window[c.tagObjectCallbackName]=function(d){var h=window._dv_win.$dvbs;if(h){var k=b?"https:":M();e=d.ImpressionID;h.tags.add(d.ImpressionID,c);h.tags[d.ImpressionID].set({tagElement:c.script,
impressionId:d.ImpressionID,dv_protocol:c.protocol,protocol:k,uid:c.uid,serverPublicDns:d.ServerPublicDns,ServerPublicDns:d.ServerPublicDns});c.script&&c.script.dvFrmWin&&(c.script.dvFrmWin.$uid=d.ImpressionID,h.messages&&h.messages.startSendingEvents&&h.messages.startSendingEvents(c.script.dvFrmWin,d.ImpressionID));(function(){function c(){var e=window._dv_win.document.visibilityState;"prerender"===f&&"prerender"!==e&&"unloaded"!==e&&(f=e,window._dv_win.$dvbs.registerEventCall(d.ImpressionID,{prndr:0}),
...
e=c.innerHTML.replace(f,"\x3c/script>");c=d(c);c.hasPassback=!0;return c}return{isBadImp:!0,hasPassback:!1,tagAdTag:b,tagPassback:e}};return d(c)}function J(c,b,e,f,d,h,k,l,m,t,g,w){void 0==b.dvregion&&(b.dvregion=0);try{f.depth=R(f);var p=S(f);var n="&aUrl="+encodeURIComponent(p.url);var q="&aUrlD="+p.depth;var v=f.depth+d;h&&f.depth--}catch(u){q=n=v=f.depth=""}void 0!=b.aUrl&&(n="&aUrl="+b.aUrl);a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var r=1;break a}}catch(u){}r=
0}h=function(){function c(b){d++;var e=b.parent==b;return b.mraid||e?b.mraid:20>=d&&c(b.parent)}var b=window._dv_win||window,d=0;try{return c(b)}catch(x){}}();d=b.script.src;r="&ctx="+(dv_GetParam(d,"ctx")||"")+"&cmp="+(dv_GetParam(d,"cmp")||"")+"&plc="+(dv_GetParam(d,"plc")||"")+"&sid="+(dv_GetParam(d,"sid")||"")+"&advid="+(dv_GetParam(d,"advid")||"")+"&adsrv="+(dv_GetParam(d,"adsrv")||"")+"&unit="+(dv_GetParam(d,"unit")||"")+"&isdvvid="+(dv_GetParam(d,"isdvvid")||"")+"&uid="+b.uid+"&tagtype="+(dv_GetParam(d,
...
var c=!1;try{var b=document.createElement("p");b.innerText=".";b.style="text-shadow: rgb(99, 116, 171) 20px -12px 2px";c=void 0!=b.style.textShadow}catch(e){}return(0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")||window.webkitAudioPannerNode&&window.webkitConvertPointFromNodeToPage)&&c&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(e){return 0}}function X(){try{var c=0,b=function(b,d){d&&32>b&&(c=(c|1<<b)>>>0)},e=function(b,c){return function(){return b.apply(c,
arguments)}},f="svg"===document.documentElement.nodeName.toLowerCase(),d=function(){return"function"!==typeof document.createElement?document.createElement(arguments[0]):f?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},h=["Moz","O","ms","Webkit"],k=["moz","o","ms","webkit"],l={style:d("modernizr").style},m=function(b,c){function e(){g&&(delete l.style,delete l.modElem)}var f;for(f=["modernizr","tspan","samp"];!l.style&&
f.length;){var g=!0;l.modElem=d(f.shift());l.style=l.modElem.style}var h=b.length;for(f=0;f<h;f++){var k=b[f];~(""+k).indexOf("-")&&(k=cssToDOM(k));if(void 0!==l.style[k])return e(),"pfx"==c?k:!0}e();return!1},t=function(b,c,d){var f=b.charAt(0).toUpperCase()+b.slice(1),g=(b+" "+h.join(f+" ")+f).split(" ");if("string"===typeof c||"undefined"===typeof c)return m(g,c);g=(b+" "+k.join(f+" ")+f).split(" ");for(var l in g)if(g[l]in c){if(!1===d)return g[l];b=c[g[l]];return"function"===typeof b?e(b,d||
c):b}return!1};b(0,!0);b(1,t("requestFileSystem",window));b(2,window.CSS?"function"==typeof window.CSS.escape:!1);b(3,t("shapeOutside","content-box",!0));return c}catch(g){return 0}}function K(){var c=window,b=0;try{for(;c.parent&&c!=c.parent&&c.parent.document&&!(c=c.parent,10<b++););}catch(e){}return c}function Y(){try{var c=K(),b=0,e=0,f=function(c,d,f){f&&(b+=Math.pow(2,c),e+=Math.pow(2,d))},d=c.document;f(14,0,c.playerInstance&&d.querySelector('script[src*="ads-player.com"]'));f(14,1,(c.CustomWLAdServer||
c.DbcbdConfig)&&(a=d.querySelector('p[class="footerCopyright"]'),a&&a.textContent.match(/ MangaLife 2016/)));f(15,2,c.zpz&&c.zpz.createPlayer);f(15,3,c.vdApp&&c.vdApp.createPlayer);f(15,4,d.querySelector('body>div[class="z-z-z"]'));f(16,5,c.xy_checksum&&c.place_player&&(c.logjwonready&&c.logContentPauseRequested||c.jwplayer));f(17,6,c==c.top&&""==d.title?(a=d.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);f(17,
7,d.querySelector('script[src*="sitewebvideo.com"]'));f(17,8,c.InitPage&&c.cef&&c.InitAd);f(17,9,c==c.top&&""==d.title?(a=d.querySelector("body>#player"),null!=a&&null!=(null!=a.querySelector('div[id*="opti-ad"]')||a.querySelector('iframe[src="about:blank"]'))):!1);f(17,10,c==c.top&&""==d.title&&c.InitAdPlayer?(a=d.querySelector('body>div[id="kt_player"]'),null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);f(17,11,null!=c.clickplayer&&null!=c.checkRdy2);f(19,12,c.instance&&c.inject&&
d.querySelector('path[id="cp-search-0"]'));f(20,13,function(){try{if(c.top==c&&0<c.document.getElementsByClassName("asu").length)for(var b=c.document.styleSheets,d=0;d<b.length;d++)for(var f=c.document.styleSheets[d].cssRules,e=0;e<f.length;e++)if("div.kk"==f[e].selectorText||"div.asu"==f[e].selectorText)return!0}catch(q){}}());a:{try{var h=null!=d.querySelector('div[id="kt_player"][hiegth]');break a}catch(g){}h=void 0}f(21,14,h);a:{try{var k=c.top==c&&null!=c.document.querySelector('div[id="asu"][class="kk"]');
break a}catch(g){}k=void 0}f(22,15,k);a:{try{var l=d.querySelector('object[data*="/VPAIDFlash.swf"]')&&d.querySelector('object[id*="vpaid_video_flash_tester_el"]')&&d.querySelector('div[id*="desktopSubModal"]');break a}catch(g){}l=void 0}f(25,16,l);var m=navigator.userAgent;if(m&&-1<m.indexOf("Android")&&-1<m.indexOf(" wv)")&&c==window.top){var t=d.querySelector('img[src*="dealsneartome.com"]')||(c.__cads__?!0:!1)||0<d.querySelectorAll('img[src*="/tracker?tag="]').length;f(28,17,t||!1)}f(29,18,/doubleclick.net.*request_pkg=.*(financialsolution.crypton|freakengine|freak.engine)/i.test(window.document.referrer));
return{f:b,s:e}}catch(g){return null}}function Z(){try{var c="&fcifrms="+window.top.length;window.history&&(c+="&brh="+window.history.length);var b=K(),e=b.document;if(b==window.top){c+="&fwc="+((b.FB?1:0)+(b.twttr?2:0)+(b.outbrain?4:0)+(b._taboola?8:0));try{e.cookie&&(c+="&fcl="+e.cookie.length)}catch(f){}b.performance&&b.performance.timing&&0<b.performance.timing.domainLookupStart&&0<b.performance.timing.domainLookupEnd&&(c+="&flt="+(b.performance.timing.domainLookupEnd-b.performance.timing.domainLookupStart));
e.querySelectorAll&&(c+="&fec="+e.querySelectorAll("*").length)}return c}catch(f){return""}}function V(){function c(b){if(null==b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,e=7;0<=e;e--)d=b>>>4*e&15,c+=d.toString(16);return c},f=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);for(var e=Math.ceil((b.length/4+2)/16),g=Array(e),h=0;h<e;h++){g[h]=Array(16);for(var p=0;16>p;p++)g[h][p]=b.charCodeAt(64*h+4*p)<<24|b.charCodeAt(64*h+4*
p+1)<<16|b.charCodeAt(64*h+4*p+2)<<8|b.charCodeAt(64*h+4*p+3)}g[e-1][14]=8*(b.length-1)/Math.pow(2,32);g[e-1][14]=Math.floor(g[e-1][14]);g[e-1][15]=8*(b.length-1)&4294967295;b=1732584193;p=4023233417;var n=2562383102,q=271733878,v=3285377520,r=Array(80);for(h=0;h<e;h++){for(var u=0;16>u;u++)r[u]=g[h][u];for(u=16;80>u;u++)r[u]=c(r[u-3]^r[u-8]^r[u-14]^r[u-16],1);var D=b;var y=p;var x=n;var z=q;var A=v;for(u=0;80>u;u++){var E=Math.floor(u/20),B=c(D,5);a:{switch(E){case 0:var C=y&x^~y&z;break a;case 1:C=
y^x^z;break a;case 2:C=y&x^y&z^x&z;break a;case 3:C=y^x^z;break a}C=void 0}E=B+C+A+f[E]+r[u]&4294967295;A=z;z=x;x=c(y,30);y=D;D=E}b=b+D&4294967295;p=p+y&4294967295;n=n+x&4294967295;q=q+z&4294967295;v=v+A&4294967295}return d(b)+d(p)+d(n)+d(q)+d(v)}function b(){try{return!!window.sessionStorage}catch(h){return!0}}function e(){try{return!!window.localStorage}catch(h){return!0}}function f(){try{var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var c=b.getContext("2d");c.textBaseline=
"top";c.font="14px 'Arial'";c.textBaseline="alphabetic";c.fillStyle="#f60";c.fillRect(0,0,62,20);c.fillStyle="#069";c.fillText("!image!",2,15);c.fillStyle="rgba(102, 204, 0, 0.7)";c.fillText("!image!",4,17);return b.toDataURL()}}catch(l){}return null}try{var d=[];d.push(["lang",navigator.language||navigator.browserLanguage]);d.push(["tz",(new Date).getTimezoneOffset()]);d.push(["hss",b()?"1":"0"]);d.push(["hls",e()?"1":"0"]);d.push(["odb",typeof window.openDatabase||""]);d.push(["cpu",navigator.cpuClass||
""]);d.push(["pf",navigator.platform||""]);d.push(["dnt",navigator.doNotTrack||""]);d.push(["canv",f()]);return c(d.join("=!!!="))}catch(h){return null}}this.createRequest=function(){var c=!1,b=window._dv_win,e=0,f=!1,d;try{for(d=0;10>=d;d++)if(null!=b.parent&&b.parent!=b)if(0<b.parent.location.toString().length)b=b.parent,e++,c=!0;else{c=!1;break}else{0==d&&(c=!0);break}}catch(v){c=!1}a:{try{var h=b.$sf;break a}catch(v){}h=void 0}if(0==b.document.referrer.length)c=b.location;else if(c)c=b.location;
else{c=b.document.referrer;if(G(c)){a:{try{var k=b.$sf&&b.$sf.ext&&b.$sf.ext.hostURL&&b.$sf.ext.hostURL();break a}catch(v){}k=void 0}if(k&&!G(k)&&0==k.indexOf(c)){c=k;var l=!0}}f=!0}if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};d=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();
k=d.script;this.dv_script_obj=d;this.dv_script=k;window._dv_win.dvbsProcessed.push(d);window._dv_win._dvScripts.push(k);var m=k.src;this.dvOther=0;this.dvStep=1;var t=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():A():A();d=window.parent.postMessage&&window.JSON;var g=!0,w=!1;if("0"==dv_GetParam(m,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)w=!0;if(d&&0==
w)try{var p=H(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html","bst2t_"+t);g=B(p)}catch(v){}p={};try{w=/[\?&]([^&]*)=([^&#]*)/gi;for(var n=w.exec(m);null!=n;)"eparams"!==n[1]&&(p[n[1]]=n[2]),n=w.exec(m);var q=p}catch(v){q=p}q.perf=this.perf;q.uid=t;q.script=this.dv_script;q.callbackName="__verify_callback_"+q.uid;q.tagObjectCallbackName="__tagObject_callback_"+q.uid;q.tagAdtag=null;q.tagPassback=null;q.tagIntegrityFlag="";q.tagHasPassbackFlag="";0==(null!=q.tagformat&&
"2"==q.tagformat)&&(n=Q(q.script),q.tagAdtag=n.tagAdTag,q.tagPassback=n.tagPassback,n.isBadImp?q.tagIntegrityFlag="&isbadimp=1":n.hasPassback&&(q.tagHasPassbackFlag="&tagpb=1"));(n=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream)?p="https:":(p=q.script.src,m="http:",t=window._dv_win.location.toString().match("^http(?:s)?"),"https"!=p.match("^https")||"https"!=t&&"http"==
t||(m="https:"),p=m);q.protocol=p;q.ssl="0";"https:"===q.protocol&&(q.ssl="1");p=q;(m=window._dv_win.dvRecoveryObj)?("2"!=p.tagformat&&(m=m[p.ctx]?m[p.ctx].RecoveryTagID:m._fallback_?m._fallback_.RecoveryTagID:1,1===m&&p.tagAdtag?document.write(p.tagAdtag):2===m&&p.tagPassback&&document.write(p.tagPassback)),p=!0):p=!1;if(p)return{isSev1:!0};this.dvStep=2;P(q,n);k=k&&k.parentElement&&k.parentElement.tagName&&"HEAD"===k.parentElement.tagName;this.dvStep=3;return J(this,q,c,b,e,f,d,g,k,n,l,h)};this.sendRequest=
function(c){var b=dv_GetParam(c,"tagformat");b&&"2"==b?$dvbs.domUtilities.addScriptResource(c,document.body):dv_sendScriptRequest(c);try{if("1"!=dv_GetParam(c,"foie")){var e=N(this.dv_script_obj&&this.dv_script_obj.injScripts),f=H("about:blank");f.id=f.name;var d=f.id.replace("iframe_","");f.setAttribute&&f.setAttribute("data-dv-frm",d);B(f,this.dv_script);if(this.dv_script){var h=this.dv_script;a:{c=null;try{if(c=f.contentWindow){var k=c;break a}}catch(g){}try{if(c=window._dv_win.frames&&window._dv_win.frames[f.name]){k=
c;break a}}catch(g){}k=null}h.dvFrmWin=k}a:{var l;if(f&&(l=f.contentDocument||f.contentWindow&&f.contentWindow.document)){var m=l;break a}m=(l=window._dv_win.frames&&window._dv_win.frames[f.name]&&window._dv_win.frames[f.name].document)?l:null}if(m)m.open(),m.write(e);else{try{document.domain=document.domain}catch(g){}var t=encodeURIComponent(e.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));f.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+
t+"');})()"}}}catch(g){e=(window._dv_win.dv_config=window._dv_win.dv_config||{}).tpsAddress||"rtb0.doubleverify.com",f=[this.getVersionParamName(),this.getVersion()].join("="),e+=["/verify.js?ctx=818052&cmp=1619415&num=6",f].join("&"),dv_SendErrorImp(e,[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(g)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=J);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"122"}}
;
